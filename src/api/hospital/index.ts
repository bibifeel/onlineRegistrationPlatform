...
import { DeparmentResponseData, HospitalDetail, HospitalWorkData, LoginData, UserLoginResponseData, WxLoginResponseData } from "./type";
// 枚举请求地址
enum API {
...
// 获取某一个医院的科室的数据
export const reqHospitalDepartment = (hoscode: string) => request.get<any, DeparmentResponseData>(API.HOSPITALDEPARMENT_URL + hoscode);
// 获取验证码接口
...
// 获取挂号医生的信息
export const reqDoctorInfo = (scheduleId: string) => request.get<any, any>(API.GETDOCTOR_URL + scheduleId);